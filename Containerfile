...
ARG BASE_IMAGE_TAG=stream10@sha256:0930c83cce3962dd834f206dbfc523a20547bbae268ccb1ca98a7b03acd4b3ea
ARG BASE_IMAGE_DIGEST=""
FROM ${BASE_IMAGE_REGISTRY}:${BASE_IMAGE_TAG}${BASE_IMAGE_DIGEST:+@${BASE_IMAGE_DIGEST}} AS base
